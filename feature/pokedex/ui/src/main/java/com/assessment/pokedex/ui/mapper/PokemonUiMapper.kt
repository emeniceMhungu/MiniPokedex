...
import com.assessment.pokedex.ui.model.UiPokemonId as UiPokemonId
import com.assessment.pokedex.ui.model.UiPokemonName as UiPokemonName
import com.assessment.pokedex.ui.model.UiImageUrl as UiImageUrl
...
fun PokemonCharacterWithDetails.toUiModel(): PokemonCharacterWithDetailsUiModel {
    return PokemonCharacterWithDetailsUiModel(
        ...
        uiDisplayName = UiDisplayName(this.name.capitalized()),
        uiImageUrl = UiImageUrl(this.imageUrl.value),
