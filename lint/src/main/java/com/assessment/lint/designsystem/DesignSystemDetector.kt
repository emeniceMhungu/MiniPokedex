 ...
 * the MiniPokedexApp design system module.
 */
    ...
    companion object {
        ...
        val ISSUE: Issue = Issue.create(
            ...
            explanation = "This check highlights calls in code that use Compose Material " +
                "composables instead of equivalents from the MiniPokedexApp design system " +
                "module.",
        ...
        val METHOD_NAMES = mapOf(
            "MaterialTheme" to "MiniPokedexTheme",
            "Background" to "MiniPokedexAppBackground",

        )
        val RECEIVER_NAMES = mapOf(
            "Icons" to "MiniPokedexAppIcons",
        )
